...
public let kCustomDecorationViewKind = "CustomDecorationView"
public class CustomDecorationView: UICollectionReusableView {
...
public protocol AlignDelegateFlowLayout: UICollectionViewDelegateFlowLayout {
...
public class AlignFlowLayout: UICollectionViewFlowLayout {
    
    /// 默认自动对齐
    public var direction: AlignDirection = .auto
    ...
    //重新绘制布局
    public func reloadlayoutAttributes() {
